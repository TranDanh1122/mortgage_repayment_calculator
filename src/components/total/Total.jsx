...
const Total = () => {
    ...
    return (
        <div className="bg-Slate_900 p-10 pb-28 rounded-bl-[128px] w-[55%]">
            <div className={clsx("", { "hidden": !total && !monthlyTotal })}>
                <h2 className="text-2 text-white ">Your Result</h2>
                <p className="text-4 text-Slate_300 mt-5 mb-10">Your results are shown below based on the information you provided. To adjust the results, edit the form and click “calculate repayments” again.</p>
            ...
            <div className={clsx("flex-col items-center justify-center", { "hidden": total && monthlyTotal, "flex": !total && !monthlyTotal })}>
                ...
                <p className="text-4 text-Slate_300 mt-5 mb-10">Complete the form and click “calculate repayments” to see what your monthly repayments would be.</p>
            </div>
        </div>
    )
}
